...
import registerValidate from "../validations/user.js";
...
async function register(req, res) {
    try {
        ...
        let { fullname, email, password, role, image, year } = value;
...
export { findAll, findOne, update, remove, sendOtp, verifyOtp, register, login };
